...
COPY(
   ...
   SELECT
      ...
      translate(
          array_to_string(
              ARRAY[initcap(wrapped.kind::text), initcap(wrapped.type::text), initcap(wrapped.format::text), initcap(wrapped.gender::text), initcap(wrapped.packaging::text)],
              ','),
          ' _"', '') AS "l:label",
